...
function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'doctors': return <DoctorsManage />;
      case 'staff': return <StaffManage />;
      case 'children': return <ChildManage />;
      case 'mothers': return <PregnantMothersManage />;
      case 'vaccines': return <VaccineManage />;
      case 'medicine': return <MedicineManage />;
